...
install_framework()
{
  local source="${BUILT_PRODUCTS_DIR}/Pods-UINavigationControllerWithCompletionBlock_Example/$1"
...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework 'UINavigationControllerWithCompletionBlock.framework'
fi
